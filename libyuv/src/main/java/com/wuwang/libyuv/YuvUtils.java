...
public class YuvUtils {
    ...
    public static native int I420ToRgb24(int type,byte[] yuv,byte[] rgba,int width,int height);
    ...
    public static native void I4202RGB24(byte[] src,byte[] dst,int width,int height);
