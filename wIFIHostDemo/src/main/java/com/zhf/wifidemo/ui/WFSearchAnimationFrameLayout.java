 ...
 *
 */
public class WFSearchAnimationFrameLayout extends FrameLayout{

	private SoftReference<Bitmap> m_bitmapRipple;//波纹 （软引用）
	private ImageView[] m_imageVRadars;

	public WFSearchAnimationFrameLayout(Context paramContext) {
		super(paramContext);
		init();
	}
	...
	final class WTSearchAnimationHandler implements Animation.AnimationListener {
		...
		public WTSearchAnimationHandler(
				WFSearchAnimationFrameLayout paramImageView, ImageView imageView) {
